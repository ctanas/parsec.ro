...
SELECT to_char(launchDate, 'DD.MM HH24:MI') AS "Data", lv_type AS "Lansator", lv_serial AS "Config", lv_Payload AS "Satelit", ls_state AS "T", lv_name AS "Centru", lv_launchpad AS "Rampă", lv_outcome AS "R.", lv_buletin AS "Bul" 
  FROM launches
